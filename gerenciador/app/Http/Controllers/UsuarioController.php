...
class UsuarioController extends Controller
{
    ...
    public function perfil($id){
        ...
        $franquia = Franquia::find($usuario->franquia_id);

        return view('usuarios.profile', compact('usuario','franquia'));
    }
    ...
    public function editar($id){
        ...
        $usuario = User::find($id);
        return view('usuarios.editar', compact('usuario', 'franquias'));
    }
    ...
    public function novo(){
        ...
        return view('usuarios.novo', compact('franquias'));
    }
    ...
    public function incluir(Request $request){
        ...
        $usuario->franquia_id = $formData['franquia_id'];
        $usuario->image = '';
        $save = $usuario->save();
