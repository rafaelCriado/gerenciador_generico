        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-warning card-outline">
              ...
              <span class="text-muted text-center">{{$franquia->nome_fantasia}}</span><br>
              <span class="text-muted text-center">{{$franquia->endereco_cidade}} - {{$franquia->endereco_estado}} <br> Tel. {{$franquia->telefone}}</span>
